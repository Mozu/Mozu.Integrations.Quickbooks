...
import com.mozu.qbintegration.model.Setting;
import com.mozu.qbintegration.utils.ApplicationUtils;

/**
 * Manage the quickbooks configuration setting in the database
 * 
 * @author john_gatti
 *
 */
...
public class ConfigHandler {
    ...
    private final String TENANT_DB_ENTRY = "mozu-qb-settings";

    public ConfigHandler() { 
    }

    /**
     * Get the quickbooks integration settings for the tenant
    ...
    /**
     * Get the quickbooks-integration setting for the tenant
     * 
    ...
    /**
     * Save configuration settings for the tenant
     * 
     * @param tenantId tenant id
