 ...
 *         &lt;element ref="{}FromAccountBalance" minOccurs="0"/>
 *         &lt;element ref="{}TransferToAccountRef" minOccurs="0"/>
 *         &lt;element ref="{}ToAccountBalance" minOccurs="0"/>
...
@XmlRootElement(name = "TransferRet")
public class TransferRet {
    ...
    @XmlElement(name = "FromAccountBalance")
    protected String fromAccountBalance;
    @XmlElement(name = "TransferToAccountRef")
    protected TransferToAccountRef transferToAccountRef;
    @XmlElement(name = "ToAccountBalance")
    protected String toAccountBalance;
     ...
     *     
     */
    public void setFromAccountBalance(String value) {
     ...
     *     
     */
    public void setToAccountBalance(String value) {
